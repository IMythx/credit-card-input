...
export interface CreditCardInputsInterface {
    ...
    maskNumberInput(target: HTMLInputElement, cardType: Partial<Pick<ReturnType<typeof creditCardType>[number], "lengths" | "gaps">>): void;
...
export type Icons = Record<cardTypes, string> & {
    default: string;
};
